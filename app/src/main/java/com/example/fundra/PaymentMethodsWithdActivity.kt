...
import com.example.fundra.databinding.ActivityPaymentMethodsWithdBinding
import com.google.android.material.bottomsheet.BottomSheetDialogFragment

class PaymentMethodsWithdActivity : BottomSheetDialogFragment() {
    private var _binding: ActivityPaymentMethodsWithdBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = ActivityPaymentMethodsWithdBinding.inflate(inflater, container, false)
